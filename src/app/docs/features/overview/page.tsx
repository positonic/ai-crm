  ...
  return (
    <>
      ...
      <p className="docs-page-subtitle">
        A complete look at everything the Impactful Events platform has to
        offer.
      </p>
      ...
      <p className="docs-text">
        ...
        handles everything from submitting your interest to tracking your
        status. Forms save automatically as you type, so you never lose your
        work. Organisers review applications and you are notified by email when
        a decision is made.
      </p>
      ...
      <p className="docs-text">
        ...
        let participants showcase the work they create during events. You can
        add descriptions, link code repositories, post timeline updates, and
